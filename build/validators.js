 ...
 */
export function validatePluginHeaders(projectPath) {
    const result = {
        valid: true,
        errors: [],
        warnings: [],
    ...
    try {
        ...
        result.valid = false;
        result.errors.push(`Error reading plugin: ${error.message}`);
    }
    return result;
}
/**
 ...
 */
export function validateThemeHeaders(projectPath) {
    const result = {
        valid: true,
        errors: [],
        warnings: [],
    ...
    try {
        ...
        result.valid = false;
        result.errors.push(`Error reading theme: ${error.message}`);
    }
    return result;
}
/**
 * Validate readme.txt
 */
export function validateReadme(projectPath) {
    const result = {
        valid: true,
        errors: [],
        warnings: [],
    ...
    try {
        ...
        result.valid = false;
        result.errors.push(`Error reading readme.txt: ${error.message}`);
    }
    return result;
}
/**
 ...
 */
export function validateTextDomain(projectPath, expectedDomain) {
    const result = {
        valid: true,
        errors: [],
        warnings: [],
    ...
    try {
        ...
        result.errors.push(`Error checking text domain: ${error.message}`);
    }
    return result;
}
/**
 ...
 */
export function validatePotFile(projectPath, textDomain) {
    ...
    try {
        ...
        result.errors.push(`Error reading POT file: ${error.message}`);
        result.valid = false;
    }
    return result;
}
 ...
 */
export function validateStableTagMatch(projectPath) {
    const result = { valid: true, errors: [], warnings: [], info: {} };
    const readmePath = join(projectPath, 'readme.txt');
    if (!existsSync(readmePath))
        return result;
 ...
 */
export function validateGplLicense(projectPath) {
    const result = { valid: true, errors: [], warnings: [], info: {} };
 ...
 */
export function validateUninstallCleanup(projectPath) {
    const result = { valid: true, errors: [], warnings: [], info: {} };

...
export const DEPRECATED_FUNCTIONS: DeprecatedFunction[] = [
  // WP 2.x - 3.x
 ...
 */
export function buildDeprecatedMap(): Map<string, DeprecatedFunction> {
  const map = new Map<string, DeprecatedFunction>();
